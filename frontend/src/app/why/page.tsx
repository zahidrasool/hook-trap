...
const reasons = [
  ...
  },
  {
    ...
    title: "121 Dynamic Data Generators",
    description: "Generate realistic fake data with built-in templates like {{faker.name}}, {{faker.email}}, {{faker.uuid}} — 121 generators in total, plus direct access to any Faker method. No plugins, no setup — it just works.",
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            ...
            <div className="bg-emerald-50/50 dark:bg-emerald-900/20 border border-emerald-100 dark:border-emerald-800 rounded-xl p-8">
              ...
              <ul className="space-y-3">
                {[
                  ...
                  "121 dynamic data generators built-in",
