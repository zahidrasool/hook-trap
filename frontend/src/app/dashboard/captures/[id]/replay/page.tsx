  ...
  return (
    <div className="max-w-4xl w-full">
      <Link
        ...
        className="inline-flex items-center gap-1.5 text-sm text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 transition-colors mb-6"
      >
      ...
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-slate-900 dark:text-white tracking-tight">Replay Webhook</h1>
        <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Forward a captured webhook to a target URL with optional modifications.</p>
      </div>

      {/* Original Capture */}
      <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200/60 dark:border-slate-700 shadow-sm p-5 mb-6">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h2 className="text-sm font-semibold text-slate-700 dark:text-slate-300">Original Capture</h2>
        </div>
        <div className="flex items-center gap-3 mb-3 flex-wrap">
          ...
          <span className="font-mono text-sm text-slate-600 dark:text-slate-300 break-all">{capture.path}</span>
        </div>
        {capture.body && (
      ...
      <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200/60 dark:border-slate-700 shadow-sm p-6 mb-6">
        <div className="flex items-center gap-2 mb-5">
          ...
          <h2 className="text-sm font-semibold text-slate-700 dark:text-slate-300">Replay Configuration</h2>
        </div>
        ...
        <div className="mb-5">
          ...
          <input
            ...
            className="w-full px-4 py-2.5 rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-800 text-sm text-slate-900 dark:text-slate-100 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-300 transition-all"
          />
        </div>
        ...
        <div className="mb-5">
          ...
          <textarea
            ...
            rows={3}
            className="w-full px-4 py-2.5 rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-800 font-mono text-sm text-slate-900 dark:text-slate-100 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-300 transition-all resize-none"
          />
        </div>
      ...
      {result && (
        <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200/60 dark:border-slate-700 shadow-sm p-6">
          <div className="flex items-center gap-2 mb-5">
            ...
            <h2 className="text-sm font-semibold text-slate-700 dark:text-slate-300">Replay Result</h2>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-5">
            <div className="bg-slate-50/80 dark:bg-slate-800/50 rounded-xl p-4 border border-slate-100 dark:border-slate-700">
            ...
            <div className="bg-slate-50/80 dark:bg-slate-800/50 rounded-xl p-4 border border-slate-100 dark:border-slate-700">
              ...
              <p className="text-2xl font-bold text-slate-900 dark:text-white mt-1 tabular-nums">{result.response_time_ms}<span className="text-sm font-normal text-slate-400 ml-0.5">ms</span></p>
            </div>
            <div className="bg-slate-50/80 dark:bg-slate-800/50 rounded-xl p-4 border border-slate-100 dark:border-slate-700">
              <span className="text-xs font-medium text-slate-400 uppercase tracking-wider">Replayed At</span>
              <p className="text-sm text-slate-600 dark:text-slate-300 mt-2">{new Date(result.replayed_at).toLocaleString()}</p>
            </div>
          </div>

          {result.error_message && (
            <div className="flex items-start gap-2 bg-red-50 dark:bg-red-900/20 text-red-700 dark:text-red-300 p-4 rounded-xl mb-4 text-sm border border-red-100 dark:border-red-800">
