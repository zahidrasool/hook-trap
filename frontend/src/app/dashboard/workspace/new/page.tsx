...
export default function NewWorkspacePage() {
  ...
  return (
    <div className="max-w-lg mx-auto mt-8">
      <Link
        href="/dashboard"
        className="inline-flex items-center gap-1.5 text-base text-slate-500 hover:text-slate-700 transition-colors mb-6"
      >
      ...
      <div className="mb-8">
        ...
        <p className="text-base text-slate-500 mt-2">Set up a new workspace to organize your mock APIs.</p>
      </div>

      <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-slate-200/60 shadow-sm p-6 sm:p-8">
        <div className="mb-5">
