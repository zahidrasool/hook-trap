...
msg["Subject"] = "Welcome to HookTrap - Test Email"

text_body = "Hello! This is a test email sent through HookTrap fake SMTP inbox."
html_body = (
    "<html><body>"
    '<h1 style="color: #4f46e5;">Welcome to HookTrap!</h1>'
